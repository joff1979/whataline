...
const pullQuotes = [
  {
    text: 'Kat is the breath of fresh air you never expect to find, but always welcome, amongst the chaos of film and TV production.',
    attr: 'Director, rocking horse media',
  },
  {
    text: 'If Kat was on Trip Advisor, I\'d be giving her 5 stars!',
    attr: 'Producer',
  },
];

const credits: { role: string; items: { title: string; company?: string; year?: string }[] }[] = [
  {
        ...
        <div className="container mx-auto max-w-3xl">
          ...
          <motion.div {...fadeUp(0.2)} className="mt-8 space-y-5 max-w-2xl">
            <p className="font-body text-base font-light leading-relaxed"
              ...
              Kat is an award-winning multi-hyphenate filmmaker with experience across Script Supervision,
              Producing, Screenwriting and Directing, and a passion for crafting engaging stories.
            </p>
            <p className="font-body text-base font-light leading-relaxed"
               style={{ color: 'rgba(250,247,242,0.8)' }}>
              As a screenwriter, Kat specialises in poignant drama and romance, often with a twist of magical
              realism or a hint of wry humour. Her flair for creating quirky storylines and layered characters
              has resulted in incredible feedback, acknowledging her masterful storytelling and charming style.
              Kat laughs, cries and screams right alongside her characters — resulting in authentic,
              compelling scripts.
            </p>
            <p className="font-body text-base font-light leading-relaxed"
               style={{ color: 'rgba(250,247,242,0.8)' }}>
              Kat's years of Project Management experience outside of the film industry ideally place her to
              steer through the complexity of all phases of production with a unique blend of collaboration,
              structure, creativity and empathy — and she often gets invited back.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto grid md:grid-cols-2 gap-10 max-w-4xl">
          {pullQuotes.map(({ text, attr }, i) => (
            ...
            >
              ...
              <p
                className="font-body text-base font-light italic leading-relaxed -mt-4"
          ...
          <div className="mt-8 divide-y" style={{ borderColor: 'rgba(62,41,28,0.1)' }}>
            {education.map(({ school, course, year }, i) => (
              ...
              >
                ...
                <span
                  className="font-body text-[11px] tracking-wider"
                  style={{ color: 'var(--color-text-secondary)', opacity: 0.7 }}
                >
                  {year}
                </span>
